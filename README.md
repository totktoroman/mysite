...
Использование информационной системы позволит ускорить сбор и анализ данных о прогрессе обучающихся на веб-ресурсе <a href="acmp.ru">acmp.ru</a>. В следствие чего использование информационной системы позволит преподавателю существенно экономить рабочее время про работе с большими группами учеников. 
